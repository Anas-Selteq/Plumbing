    ...
    <section id="areas" className={styles.section}>
      ...
      >
        ...
        <p className={styles.subtitle}>
          Flow Fix 24/7 provides emergency and general plumbing services
          across Birmingham and surrounding areas. From urgent leaks and
          burst pipes to blocked drains, plumbing repairs and installations,
          our team is available 24/7 to help homes and businesses with their
          plumbing needs.
        </p>
      </motion.div>
