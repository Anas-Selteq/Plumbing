...
const WORK_ITEMS = [
  {
    id: "job-1",
    img: "https://picsum.photos/seed/recent-work-1/700/900",
    caption: "Bathroom refit — Edgbaston",
  ...
  {
    id: "job-2",
    img: "https://picsum.photos/seed/recent-work-2/700/900",
    caption: "Emergency pipe repair — Erdington",
  ...
  {
    id: "job-3",
    img: "https://picsum.photos/seed/recent-work-3/700/900",
    caption: "Drain unblocking — Moseley",
    tag: "Drain Unblocking",
    icon: Waves,
    accent: "#14b8a6",
  },
  {
    id: "job-4",
    img: "https://picsum.photos/seed/recent-work-4/700/900",
    caption: "Kitchen plumbing — Harborne",
  ...
  {
    id: "job-5",
    img: "https://picsum.photos/seed/recent-work-5/700/900",
    caption: "Leak repair — Solihull",
    tag: "Leak Repair",
    icon: Droplet,
    accent: "#0ea5e9",
  },
  {
    id: "job-6",
    img: "https://picsum.photos/seed/recent-work-6/700/900",
    caption: "New installation — Sutton Coldfield",
